...
export default class CalendarColTime extends Component {
    render() {
        const startTimes = Array.from(Array(36).keys());
        return (
...
function indexToTime(index) {
    ...
    time = time == "12:00 PM" ? "12:00 AM" : time;
    time = time == "12:30 PM" ? "12:00 AM" : time;
    ...
    time = time == "14:00 PM" ? "2:00 AM" : time;
    return time
}
